...
//获取天气
String url = "https://api.seniverse.com/v3/weather/now.json"; // 获取当天天气
String key = "Sq9D2GX9Rie6Gljzv";
String locations = "深圳";
String language = "zh-Hans";
String unit = "c";

String url_2 = "https://api.seniverse.com/v3/weather/daily.json"; // 获取未来天气
String start = "0";
String days = "3";
#define get_days 3
...
void weather_get(void)
{
    ...
    lv_label_set_text_fmt( ui_LabelTemp, "温度:%s度", temp.c_str());
